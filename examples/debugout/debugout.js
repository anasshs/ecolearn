...
function debugout() {
	...
	self.maxLines = 9500; // if autoTrim is true, this many most recent lines are saved
	self.tailNumLines = 100; // how many lines tail() will retrieve
	self.logFilename = 'outputemotion.txt'; // filename of log downloaded with downloadLog()
